...
static const char *_getopt_initialize_a (char const *optstring, struct _getopt_data_a *d, int posixly_correct)
{
...
int _getopt_internal_r_a (int argc, char *const *argv, char const *optstring, struct option_a const *longopts, int *longind, int long_only, struct _getopt_data_a *d, int posixly_correct)
{
...
int _getopt_internal_a (int argc, char *const *argv, char const *optstring, struct option_a const *longopts, int *longind, int long_only, int posixly_correct)
{
  int result;
...
static const wchar_t *_getopt_initialize_w (wchar_t const *optstring, struct _getopt_data_w *d, int posixly_correct)
{
  d->__first_nonopt = d->__last_nonopt = d->optind;
  d->__nextchar = NULL;
...
int _getopt_internal_r_w (int argc, wchar_t *const *argv, wchar_t const *optstring, struct option_w const *longopts, int *longind, int long_only, struct _getopt_data_w *d, int posixly_correct)
{
  int print_errors = d->opterr;
  if (argc < 1)
    return -1;
...
int _getopt_internal_w (int argc, wchar_t *const *argv, wchar_t const *optstring, struct option_w const *longopts, int *longind, int long_only, int posixly_correct)
{
  int result;
