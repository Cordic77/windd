/*windd: include a compatibility header for Windows systems; this header is
  split into two logical parts:
  _pre.h    definitions, which should be included before processing this file
  _post.h   definitions, which should be included after processing this file
*/
#if defined _WIN32
...
#else
#define PENDING_OUTPUT_N_BYTES 0  /* for now -- how would one retrieve this value on Windows? */
#endif /* defined _WIN32 */
