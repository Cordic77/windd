...
#ifndef COREUTILS_SYSTEM_H    /*windd: added header guard.*/
#define COREUTILS_SYSTEM_H 1
...
#pragma warning (push)
#pragma warning (disable : 4244)  /*windd: conversion from 'uintmax_t' to 'unsigned long', possible loss of data */
